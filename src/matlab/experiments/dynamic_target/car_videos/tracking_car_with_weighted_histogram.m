...
rect_width_initial = 12;
rect_height_initial = 10; 
...
%% Tune initial histogram
reference_frame= frames(:,:,:,250);
reference_frame_hsv = hsv_frames(:,:,:,250);
...
% Parameters
center_x_coordinate = 380;
center_y_coordinate = 95;
rect_width_initial = 30;
rect_height_initial = 22; 
